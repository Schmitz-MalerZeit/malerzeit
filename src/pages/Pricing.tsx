...
const TIERS: Tier[] = [
  {
    ...
    tagline: "PDF-Angebote mit deinen Firmendaten – ideal für den Einstieg",
    monthly: 14.9, yearly: 149, pdfs: 15,
    features: [
      "Bis zu 15 KI-Angebote / Monat",
      "PDF-Download mit deinen Firmen- & Adressdaten",
      "Alle Stundensätze nutzbar",
      "Spracheingabe (Diktat) überall",
      "Kundentext zum Kopieren für E-Mail",
      "Ohne eigenes Logo & ohne Firmenfarben im PDF",
      "Ohne professionellen WhatsApp-Kurztext zum direkten Versand",
      "E-Mail-Support",
    ],
  },
  {
    id: "profi", name: "Profi",
    tagline: "PDFs im eigenen Briefkopf + fertiger WhatsApp-Kurztext für Kunden",
    monthly: 24.9, yearly: 249, pdfs: 50, highlight: true,
    features: [
      "Bis zu 50 KI-Angebote / Monat",
      "Alles aus Starter",
      "Eigenes Logo & Firmenfarben im PDF-Briefkopf",
      "Professioneller, fertig formulierter Kurztext – direkt an den Kunden per WhatsApp",
  ...
  },
  {
    ...
    tagline: "Maximales Volumen: 200 KI-Angebote pro Monat – für Betriebe mit hohem Auftragsaufkommen",
